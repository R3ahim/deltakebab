        ...
        <tbody>
          ...
          {filteredData.map((expance, index ) =>
            <tr>
             ...
             <button className="px-3 py-2 text-xs font-medium text-center text-white bg-green-500 rounded-lg hover:bg-green-500 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-green-600 dark:hover:bg-geen-300 dark:focus:ring-green-500">details</button>
              <td>{expance.meet}</td> 
              <td>{expance.fudi}</td> 
